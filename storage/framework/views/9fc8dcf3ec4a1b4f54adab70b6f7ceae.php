...
<body>
    ...
    <div class="container">
    <form action="<?php echo e(route('perbelanjaan.new')); ?>" method="POST">
    <table>
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Lenovo\Desktop\internship\data_penduduk_KT\resources\views//newPerbelanjaan.blade.php ENDPATH**/ ?>