...
<body>
    ...
    <h5>MAKLUMAT PASANGAN</h5>
        <form action="<?php echo e(route('newPasangan.new')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\Lenovo\Desktop\internship\data_penduduk_KT\resources\views//newPasangan.blade.php ENDPATH**/ ?>