...
<body>
    ...
    <form action="<?php echo e(route('newPemohon.new')); ?>" method="POST">
        <?php echo csrf_field(); ?>
    <table>
        <tbody>
            <tr>
...
</html><?php /**PATH C:\Users\Lenovo\Desktop\internship\data_penduduk_KT\resources\views//newPemohon.blade.php ENDPATH**/ ?>